...
validateCompatibility({ policy, rootManifest, packages, agentlintArchive });
console.log(
  `Validated bounded Node/peer contracts for ${packages.length} packages and pinned compatibility profiles; agentlint remains local-only.`,
);
