...
```ts
/**
 * @attribution https://fast-check.dev/docs/advanced/model-based-testing/ (MIT tool docs; inspiration: model-based commands)
 * @attribution https://martinfowler.com/bliki/ContractTest.html (inspiration: contract tests against fake and real)
 * @attribution https://arxiv.org/abs/2501.12862 (paper; inspiration: mutation-guided test generation)
 */
```
